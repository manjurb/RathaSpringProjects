...
import com.css.corp.project.service.BillingService;
...
public class EmployeeController {
	...
	*/
		...
		@RequestMapping(value = "/getAllBillings", method = RequestMethod.GET, headers = "Accept=application/json")
		public String getAllBillings(Model model) {

			List<Billing> listOfBillings = billingService.getAllBillings();
			model.addAttribute("billing", new Billing());
			model.addAttribute("listOfBillings", listOfBillings);
			return "billingDetails";
		}
	
		@RequestMapping(value = "/getAllBillings1", method = RequestMethod.GET, headers = "Accept=application/json")
		public String getAllBillings1(Model model) {
		...
		@RequestMapping(value = "/getBilling/{id}", method = RequestMethod.GET, headers = "Accept=application/json")
		public Billing getBillingBys_no(@PathVariable int id) {
			return billingService.getBilling(id);
		}
		
		@RequestMapping(value = "/addBilling", method = RequestMethod.POST, headers = "Accept=application/json")
		public String addBilling(@ModelAttribute("billing") Billing billing) {	
			...
			return "redirect:/getAllBillings1";
		}		
			
		@RequestMapping(value = "/updateBilling/{id}", method = RequestMethod.GET, headers = "Accept=application/json")
		public String updateBilling1(@PathVariable("id") int id,Model model) {
			model.addAttribute("billing", this.billingService.getBilling(id));
			model.addAttribute("listOfBilling", this.billingService.getAllBillings());
			return "billingDetails";
		}
		@RequestMapping(value = "/updateBilling", method = RequestMethod.GET, headers = "Accept=application/json")
		public String updateBilling(@RequestParam("id") int id,Model model) {
			model.addAttribute("billing", this.billingService.getBilling(id));
			model.addAttribute("listOfBilling", this.billingService.getAllBillings());
			return "billingDetails";
		}
		
		@RequestMapping(value = "/deleteBilling/{id}", method = RequestMethod.GET, headers = "Accept=application/json")
